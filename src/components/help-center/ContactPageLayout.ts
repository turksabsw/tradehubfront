    ...
    <div class="bg-gray-50 min-h-screen">
      ...
      <div class="bg-gradient-to-r from-primary-500 to-orange-500 py-10 sm:py-14">
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 text-center">
          <h1 class="text-2xl sm:text-3xl font-bold text-white mb-2">Bize Ulaşın</h1>
          <p class="text-white/80 text-sm sm:text-base">Size nasıl yardımcı olabiliriz? İletişim kanallarımızdan bize ulaşabilirsiniz.</p>
        </div>
      </div>
      ...
      <div class="max-w-[1200px] mx-auto px-4 sm:px-6 py-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          ${ContactMethodCard({
            ...
            title: 'Canl\u0131 Destek',
            description: 'Anl\u0131k sohbet ile h\u0131zl\u0131 destek al\u0131n. Ortalama yan\u0131t s\u00fcresi 2 dakika.',
          ...
          ${ContactMethodCard({
            ...
            title: 'Chatbot',
            description: '7/24 otomatik yan\u0131t sistemi ile an\u0131nda \u00e7\u00f6z\u00fcm bulun.',
            ctaLabel: 'Chatbot Ba\u015flat',
          })}
        </div>
        ...
        <div class="max-w-[700px] mx-auto" x-data="contactPage()">
          <template x-if="!formSubmitted">
            <div class="bg-white rounded-lg border border-gray-200 p-6 sm:p-8">
              <h2 class="text-xl font-semibold text-gray-900 mb-6">İletişim Formu</h2>

              <div class="space-y-4">
                <!-- Name -->
                <div>
                  <label for="contact-name" class="block text-sm font-medium text-gray-700 mb-1">Ad Soyad *</label>
                  <input id="contact-name" type="text" x-model="name" class="w-full px-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-colors" :class="errors.name ? 'border-red-400' : 'border-gray-300'" placeholder="Adınız ve soyadınız">
                  <p x-show="errors.name" x-text="errors.name" class="text-xs text-red-500 mt-1"></p>
                </div>

                <!-- Email -->
                <div>
                  <label for="contact-email" class="block text-sm font-medium text-gray-700 mb-1">E-posta *</label>
                ...
                <!-- Subject -->
                <div>
                  <label for="contact-subject" class="block text-sm font-medium text-gray-700 mb-1">Konu *</label>
                ...
                <!-- Message -->
                <div>
                  <label for="contact-message" class="block text-sm font-medium text-gray-700 mb-1">Mesaj *</label>
                  <textarea id="contact-message" x-model="message" rows="5" class="w-full px-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-colors resize-y" :class="errors.message ? 'border-red-400' : 'border-gray-300'" placeholder="Mesajınızı yazın..."></textarea>
                  <p x-show="errors.message" x-text="errors.message" class="text-xs text-red-500 mt-1"></p>
                </div>

                <!-- File attachment -->
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Dosya Eki (opsiyonel)</label>
        ...
        <div class="mt-12 bg-white rounded-lg border border-gray-200 p-6 sm:p-8">
          <h2 class="text-xl font-semibold text-gray-900 mb-4">Adres Bilgileri</h2>
            ...
            <div class="flex-1">
              <div class="space-y-3 text-sm text-gray-600">
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    <p class="font-medium text-gray-800">iSTOC Teknoloji A.Ş.</p>
                    <p>İstanbul Ticaret Merkezi, Kat 12</p>
                    <p>Maslak, Sarıyer, İstanbul 34398</p>
                  </div>
                </div>
