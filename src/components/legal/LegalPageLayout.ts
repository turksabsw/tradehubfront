  ...
  return `
    <div class="bg-gray-50 min-h-screen">
      <div class="max-w-[1200px] mx-auto px-4 sm:px-6">
        ${Breadcrumb([
          { label: 'Yasal', href: '/pages/legal/terms.html' },
      ...
      <div class="max-w-[1200px] mx-auto px-4 sm:px-6 pb-16" x-data="legalToc()">
        ...
        <div class="flex items-center justify-between mb-6">
          <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Son güncelleme: ${lastUpdated}</p>
          </div>
          ...
          <aside class="hidden lg:block w-[240px] shrink-0">
            <nav class="sticky top-[72px]">
              <div class="bg-white rounded-lg border border-gray-200 p-4">
                <h3 class="text-sm font-semibold text-gray-700 mb-3">İçindekiler</h3>
                <ul class="space-y-1">
                  ${sections.map(s => `
                    <li>
                      <button
