  ...
  /* ──── Eklenti hizmetleri ──── */
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'otherServices',
        href: '/buyer-dashboard.html#payment-terms',
        submenu: [
          { label: 'Esnek ödeme koşulları: 30/60 gün', href: '/buyer-dashboard.html#payment-terms' },
          { label: 'Ürün denetimi', href: '/buyer-dashboard.html#product-inspection' },
        ],
      },
    ],
  },
