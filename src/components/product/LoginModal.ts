    ...
    <div id="rv-login-modal" class="rv-login-overlay rv-modal-hidden fixed inset-0 bg-black/50 z-[60] flex items-center justify-center">
      <div class="rv-login-modal max-w-[420px] w-[95%] p-0 rounded-2xl bg-surface shadow-modal overflow-hidden relative">
        ...
        <div class="text-center py-4 px-6" style="background:linear-gradient(135deg,#fff1f2 0%,#ffe4e6 100%)">
          <strong class="text-[#f43f5e] font-bold text-sm">İlk siparişinizde ÜCRETSİZ kargo</strong>
        </div>

        <!-- Content -->
        <div class="px-8 pb-8">
          <div class="text-2xl font-bold text-center mt-5 text-secondary-900">Giriş Yap</div>
          ...
          <div class="rv-login-footer text-center text-[13px] text-secondary-400 mt-4">
            TradeHub'da yeni misiniz? <a href="javascript:void(0)" class="text-primary-500 font-semibold no-underline cursor-pointer hover:underline">Hesap oluştur</a>
          </div>
