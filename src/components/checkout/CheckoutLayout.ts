...
export function CheckoutLayout({ leftContent, rightContent }: CheckoutLayoutProps): string {
  return `
    <div class="sc-checkout-page max-w-[1640px] mx-auto px-4 py-6">
      <div class="flex flex-col lg:flex-row gap-5 items-start w-full relative">
        ...
        <div class="w-full lg:flex-[0_0_35%] flex-shrink-0 lg:sticky lg:top-[24px] self-start z-10">
          ${rightContent}
        </div>
      </div>
    </div>
