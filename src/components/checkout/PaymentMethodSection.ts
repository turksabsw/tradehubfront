    ...
    if (suppliers.length > 1) {
      return `
        <div class="p-6 bg-[#fafafa]"
          ...
          <h3 class="text-sm font-semibold text-[#111827] mb-4">Kredi veya Banka Kartı</h3>

          <!-- Seçili kart mini özeti -->
          <div x-show="cardSaved" x-cloak class="flex items-center gap-3 p-3 rounded-lg border mb-4" style="border-color: var(--btn-bg, #ff6600); background: var(--color-primary-50, #fff9f5);">
          ...
          <!-- Form (kart yoksa veya yeni kart eklemek isteyince) -->
